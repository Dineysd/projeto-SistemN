package com.example.SistemN.ExceptionHandler;
...
// {TRATANDO EXCEÇÕES} ResponseEntityExceptionHandler captura excessões de resposta da entidade que criamos
@ControllerAdvice
public class SistemNExceptionHandler extends ResponseEntityExceptionHandler {

	@Autowired
	private MessageSource messageSource;

	@Override // capturando mensagem que não consigui ler do usuario
	...
	@Override // capturando argumento de metodos que não são validos com ex, not null
	...
	public ResponseEntity<Object> handleEmptyResultDataAccessException(EmptyResultDataAccessException ex,
		...
		String menssagemUsuario = messageSource.getMessage("recurso.nao-encontrado", null,
	...
	public ResponseEntity<Object> handleDataIntegrityViolationException(DataIntegrityViolationException ex,
		...
		String menssagemUsuario = messageSource.getMessage("recurso.operacao-nao-pemitida", null,
				LocaleContextHolder.getLocale());
		String menssagemDesenvolvedor = ExceptionUtils.getRootCause(ex).getMessage();
		// retorna a mensagem do erro
		List<Erro> erros = Arrays.asList(new Erro(menssagemUsuario, menssagemDesenvolvedor));
